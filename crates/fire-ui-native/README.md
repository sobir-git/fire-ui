...
```toml
fire-ui-native = { git = "https://github.com/sobir-git/fire-ui", tag = "v0.4.0", default-features = false, features = ["x11", "accessibility", "clipboard"] }
```
...
See [the inspection protocol](https://github.com/sobir-git/fire-ui/blob/v0.4.0/docs/inspection.md).
